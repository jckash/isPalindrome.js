...
const dividedByTwo = numbers.map(number => number / 2);
...
fruits.forEach((fruit, index) => {
  if (fruit.color === "red"){
    ...
    console.log(`The fruit with the index ${index} is neither apple nor orange`)
  }
});
...
const riceTotal = foods.reduce((acc, food) => {
...
36
console.log(`The total price of foods that have "rice" tag are ${riceTotal}.`)